...
| Version | `1.1` (project candidate build 10; build 7 remains linked and builds 8–9 are uploaded superseded candidates) |
...
Create the next archive from the `Hanco` scheme with version `1.1` and build `10` from a
