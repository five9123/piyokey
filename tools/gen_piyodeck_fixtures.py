#!/usr/bin/env python3
"""Generate deterministic cross-platform `.piyodeck` binary fixtures."""
...
def main() -> int:
    ...
    case_specs = [
        ...
        (
            "pretty-basic",
            VALID / "pretty-basic.piyodeck",
            pretty_package,
            True,
            "accepted_noncanonical",
        ),
        ("wrong-sha", INVALID / "wrong-sha.piyodeck", wrong_sha_package, False, "sha256_mismatch"),
        (
            "unpaired-surrogate",
            INVALID / "unpaired-surrogate.piyodeck",
            unpaired_surrogate_package,
            False,
            "invalid_json",
        ),
        ("bom-deck", INVALID / "bom-deck.piyodeck", bom_package, False, "invalid_json"),
        (
            "duplicate-key",
            INVALID / "duplicate-key.piyodeck",
        ...
        (
            "future-version",
            INVALID / "future-version.piyodeck",
        ...
        (
            "data-descriptor",
            INVALID / "data-descriptor.piyodeck",
        ...
        (
            "deflate-method",
            INVALID / "deflate-method.piyodeck",
            bytes(deflate_method),
            False,
            "unsupported_archive_feature",
        ),
        ("zip64", INVALID / "zip64.piyodeck", bytes(zip64), False, "unsupported_archive_feature"),
        (
            "header-mismatch",
            INVALID / "header-mismatch.piyodeck",
        ...
        (
            "hidden-preamble",
            INVALID / "hidden-preamble.piyodeck",
