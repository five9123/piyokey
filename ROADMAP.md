...
사용자 요청 #67: 기존 PR 통합과 스페인어 UI 추가. 학습 콘텐츠 원본은 보존한다. CI/리뷰 예외 승인 전 PR은 Draft로 유지한다.

한국어 UI 제거 #65/PR #66은 구현·로컬 검증을 마쳤다. #63/PR #64 위의 전용 branch에서 ja/en UI만 제공하고 연습 콘텐츠·음원은 보존한다. #64 → #66 순서로 병합 준비하며, 스택 통합 전까지 공용 파일의 중복 작업은 하지 않는다.
...
- 신규 플랫폼·추가 언어(스페인어 #67 제외)·클라우드 동기화
