...
object CurriculumCatalog {
  val chapters: List<CurriculumChapter> = listOf(
    ...
    chapter(
      5,
      "chapter_5_words",
      listOf("사랑", "친구", "학교", "음식", "여행", "사진", "음악", "선물", "오늘", "응원"),
      listOf(
        "chapter_5_travel_words" to listOf("기차", "버스", "택시", "지도", "시장", "지하철", "공항", "식당", "화장실", "관광"),
        "chapter_5_study_work_words" to listOf("회사", "공부", "선생님", "학생", "도서관", "업무", "회의", "계획", "발표", "보고서"),
      ),
    ),
    chapter(
      6,
