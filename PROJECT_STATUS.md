...
1. TYP-120에서 출시된 1.1 (24)의 Game Center 제출·재시도·순위 갱신 결함을 수정하고 구형 기본 리더보드 노출을 정리한다. 원인·재현·미확인 범위는 [조사 보고서](docs/audits/game-center-1.1-20260909/REPORT.md)를 따른다.
