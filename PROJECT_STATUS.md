...
|---|---|---|
| #125 iPad 게임 재도전 마지막 단어 잔존 | In Progress / Draft PR #128 | iOS 26.5 simulator 접근성 runtime 장애와 분리해 iPad 실기기에서 재도전 countdown의 시각·VoiceOver 상태를 확인한 뒤 Draft 해제 판단 |
