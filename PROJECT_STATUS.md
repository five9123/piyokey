...
|---|---|---|---|
| #87 / PR #88 `.typedeck` BCP 47·deck schema v2 | In Progress | `codex/87-typedeck-bcp47` / `/private/tmp/piyokey-issue87-typedeck` | draft PR에 Actions CI와 웹 Builder 호환 결과를 연결한 뒤 병합 |
...
| 열린 PR | #88 draft; 로컬 다중 플랫폼 회귀 통과 | Actions 활성화 승인과 웹 Builder v2 결과를 연결한 뒤 ready 전환 |
