...
|---|---|---|---|
| #81 / PR #82 iOS 홈 추천 두 영역 | Verify | `codex/81-home-recommendation-rows` / `/private/tmp/piyokey-issue81` | 개인화·다음 단계 각 3개, 중복 제거, iPhone 가로 스크롤·iPad 3열 구현 및 관련 단위/iPhone·iPad UI 회귀 통과. PR 리뷰·CI 필요 |
