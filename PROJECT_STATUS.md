...
|---|---|---|
| TYP-68 게임 OS 키보드 전환 IME 잔존 | Review / PR #138 (`facf2f7` fresh P2 수정) | fresh Claude review와 CI 뒤, 잠금 해제한 iPhone 16(iOS 18.6.2)·iPad Pro 11형 3세대(iPadOS 26.6)에서 5개 직접 입력 게임별 OS 한국어 키보드 10단어 연속 전환 gate 확인 |
