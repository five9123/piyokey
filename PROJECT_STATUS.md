...
1. TYP-120에서 출시된 1.1 (24)의 Game Center 결함을 수정한다. 추가 사용자 캡처로 영어·내장 두벌식 Flow 세 난이도의 결과 버튼 자체 누락이 확인되어, 버튼과 제출을 함께 막는 F7 availability 판정을 최우선 진단 대상으로 올렸다. 대역에서 차단·미회복을 재현했으나 실제 기기의 조회 응답은 미확인이다. 제출·재시도·순위 갱신과 구형 기본 리더보드 노출도 함께 정리한다. [조사 보고서](docs/audits/game-center-1.1-20260909/REPORT.md).
