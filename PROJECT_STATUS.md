...
|---|---|---|---|
| #79 / PR #80 iPad 화면 밀도·스토어 이미지 | Verify | `codex/79-final-qa` / `/private/tmp/piyokey-issue79-final-qa` | 소스·시뮬레이터 회귀·5언어 촬영·10시장 이미지 110장 검수 완료. draft PR 리뷰/CI 후 새 RC·실기기·최종 이미지 대조·업로드 |
